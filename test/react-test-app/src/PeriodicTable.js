...
export default function PeriodicTable() {
    ...
    return (
      <div class="root-periodic">

          <div className="periodic">
          <div className="periodic-row">
            <a className="cell cell-enabled" href="/theme/hydrogen/auth/">
            ...
            <div className="cell"></div>
            <div className="cell"></div>
            <a className="cell cell-enabled" href="/theme/helium/auth/">
              <div className="element">
          ...
          <div className="periodic-row">
            <a className="cell cell-enabled" href="/theme/lithium/auth/">
              <div className="element">
