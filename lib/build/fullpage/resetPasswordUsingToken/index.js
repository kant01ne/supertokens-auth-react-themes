...
function ResetPasswordUsingTokenTheme(props) {
    ...
    if (props.hasToken) {
        return /*#__PURE__*/ React.createElement(_page["default"], {
            form: /*#__PURE__*/ React.createElement(_submitNewPassword["default"], props.submitNewPassword),
            logo: props.logo
        });
    } // Otherwise, return EnterEmail.

    return /*#__PURE__*/ React.createElement(_page["default"], {
        form: /*#__PURE__*/ React.createElement(_enterEmail["default"], props.enterEmail),
        logo: props.logo
    });
}
